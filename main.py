...
# scoref7 = fextractor.similarity_to_title(title, df)
#
#
# for key in scoref1:
#     print(key + ": " + str(scoref1[key]))
#     sql = "UPDATE `tb_sentences` SET `score_sentence_location` = '" + str(scoref1[key]) + "' WHERE sentence_index = '" + str(key) + "' AND id_datachat = '" + str(id_chat) + "'"
#     cursor.execute(sql)
#     # the connection is not autocommitted by default, so we must commit to save our changes
#     connection.commit()
#
...
#         scoref2[key]) + "' WHERE sentence_index = '" + str(key) + "' AND id_datachat = '" + str(id_chat) + "'"
#     cursor.execute(sql)
#     # the connection is not autocommitted by default, so we must commit to save our changes
#     connection.commit()
#
...
#         scoref5[key]) + "' WHERE sentence_index = '" + str(key) + "' AND id_datachat = '" + str(id_chat) + "'"
#     cursor.execute(sql)
#     # the connection is not autocommitted by default, so we must commit to save our changes
#     connection.commit()
#
...
#         scoref7[key]) + "' WHERE sentence_index = '" + str(key) + "' AND id_datachat = '" + str(id_chat) + "'"
#     cursor.execute(sql)
#     # the connection is not autocommitted by default, so we must commit to save our changes
#     connection.commit()
# # print(scoref2)
...
#         score[key]) + "' WHERE sentence_index = '" + str(key) + "' AND id_datachat = '" + str(id_chat) + "'"
#     cursor.execute(sql)
#     # the connection is not autocommitted by default, so we must commit to save our changes
#     connection.commit()
